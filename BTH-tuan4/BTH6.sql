...
SELECT (NHANVIEN.HONV + ' ' + NHANVIEN.TENLOT + ' '+ NHANVIEN.TENNV) AS 'họ tên những trưởng phòng có ít nhất một thân nhân'
...
WHERE DEAN.MADA	= PHANCONG.MADA AND
	  ...
	  NHANVIEN.HONV = N'Đinh,Trần' AND
	  NHANVIEN.TENLOT = N'Bá, Thanh' AND
	  NHANVIEN.TENNV = N'Tiến, Tâm'
